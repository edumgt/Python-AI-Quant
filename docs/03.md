...
### 위의 BE 소스를 찾고, BE 모듈 실행 및 검증 하세요.
...
def fetch_yfinance_panel(tickers, start="2022-01-01", end="2025-12-31"):
    data = {}
...
def fetch_fred(series_id, start="2022-01-01", end="2025-12-31"):
...
> 📺 [🎬 현재 경기국면](https://www.youtube.com/results?search_query=현재+경기국면+한국어)
...
> 📺 [🎬 선행 동행 후행 지표](https://www.youtube.com/results?search_query=선행+동행+후행+지표+점검+한국어)
...
> 📺 [🎬 위험 경보](https://www.youtube.com/results?search_query=위험+경보+한국어)
...
> 📺 [🎬 투자 관점 요약](https://www.youtube.com/results?search_query=투자+관점+요약+한국어)
